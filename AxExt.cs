...
{
    public static class AbletechWebApiClientArxivarExt
    {
        ...
        public static DocumentTypeBaseDTO SetDocumentType(this MaskProfileSchemaDTO self, Configuration configuration, string aooCode, string docType)
        {
